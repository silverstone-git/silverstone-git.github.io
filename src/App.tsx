...
function toggleDarkMode(){
  ...
  console.log("dark mode indicators darkmode, localstorage.theme and document.documentElement.classlist are: ");
  console.log(`${darkMode}, ${localStorage.theme}, ${document.documentElement.classList}`);
  if(darkMode) {
    localStorage.theme = 'dark'
    document.documentElement.classList.add('dark')
  } else {
...
{/* <label
  ...
  htmlFor="flexSwitchCheckDefault"></label> */}
    ...
    <div className='flex justify-center items-center bg-slate-100 dark:bg-slate-800 h-screen w-full'><div className='font-bold text-3xl text-green-600 dark:text-green-300'>Aryan Sidhwani</div></div>
